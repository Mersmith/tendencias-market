...
{
    public function getEcommerceProductosCategoria($almacen_ecommerce, $categoriaId, $lista_precio_etiqueta)
    {
    ...
    public function getEcommerceProductosDescuento($almacen_ecommerce, $lista_precio_etiqueta)
    {
        $query = DB::table('inventarios')
            ->join('variacions', 'inventarios.variacion_id', '=', 'variacions.id')
            ->join('productos', 'variacions.producto_id', '=', 'productos.id')
