...
use App\Http\Controllers\Comprador\CompradorCompraController;
...
Route::controller(CompradorCompraController::class)->group(function () {
    Route::get('/compra', 'ver')->name('compra.vista.ver');
});
