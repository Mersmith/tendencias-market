<div x-data="sliderImagenTresElementosTiempo('{{ $dataSliderImagenTresElementosTiempo['fecha_finaliza'] }}')">

    {{-- FECHA Y HORA --}}
    <div class="slider_imagen_tres_elementos_tiempo">
        ...
        <div class="contenedor_promociones slider">
            @foreach ($dataSliderImagenTresElementosTiempo['data'] as $index => $item)
                <div class="slide">
                    <a href="{{ $item['link'] }}">
                        {{-- IMAGENES --}}
