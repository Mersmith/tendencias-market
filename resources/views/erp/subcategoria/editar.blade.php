...
@section('tituloPagina', 'Editar subcategoria')
                ...
                <div class="g_columna_4">
                    <div class="g_panel">
                        ...
                        <select id="activo" name="activo">
                            <option value="0" {{ old('activo', $subcategoria->activo) == '0' ? 'selected' : '' }}>
                                DESACTIVADO
                            </option>
                    ...
                    <div class="g_panel">
                        ...
                        <!--CATEGORIA PADRE-->
                        <div class="g_margin_bottom_20">
                            <label for="categoria_padre_id">Categoria padre<span class="obligatorio"><i
                                        class="fa-solid fa-asterisk"></i></span></label>
                            <select id="categoria_padre_id" name="categoria_padre_id">
                                <option value="" @if (old('categoria_padre_id', $subcategoria->categoria_padre_id) == '') selected @endif disabled>Seleccione
                                </option>
                                @foreach ($categorias as $categoria)
                                    <option value="{{ $categoria->id }}" @if (old('categoria_padre_id', $subcategoria->categoria_padre_id) == $categoria->id) selected @endif>
